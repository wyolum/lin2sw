(function ($) {
// 20140828 ISC-J 言語スイッチャーをカスタムセレクトに変更 START
  $(function() {
    if ($('#lang_dropdown_form_language').length > 0) {
      $('.lang-dropdown-select-element').customSelect();
    }
  });
// 20140828 ISC-J 言語スイッチャーをカスタムセレクトに変更 END
